      ...
      <section className="relative">
        ...
        <div className="relative bg-white dark:bg-slate-900 shadow-xl dark:shadow-black/40 rounded-lg overflow-hidden">
          <div className="px-4 py-8 sm:p-10">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-8 text-center">Our Mission & Vision</h2>
            <div className="grid grid-cols-1 gap-10 sm:grid-cols-2">
              <div className="bg-gradient-to-b from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 p-6 rounded-lg">
                <h3 className="text-2xl font-semibold text-indigo-700 dark:text-indigo-300 mb-4">Mission</h3>
              ...
              <div className="bg-gradient-to-b from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 p-6 rounded-lg">
                <h3 className="text-2xl font-semibold text-indigo-700 dark:text-indigo-300 mb-4">Vision</h3>
                <p className="text-gray-700 dark:text-slate-300 leading-relaxed">
