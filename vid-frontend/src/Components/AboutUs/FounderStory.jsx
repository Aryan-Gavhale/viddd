      ...
      <section className="relative">
        ...
        <div className="relative bg-white dark:bg-slate-900 shadow-xl dark:shadow-black/40 rounded-lg overflow-hidden">
          <div className="px-4 py-8 sm:p-10">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-8 text-center">Our Story</h2>
            <div className="flex flex-col md:flex-row items-center md:items-start space-y-8 md:space-y-0 md:space-x-10">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-semibold text-indigo-700 dark:text-indigo-300 mb-4">How It All Began</h3>
